...
import 'package:medicalpat/Service/helpers/snack_bar.dart';
import 'package:medicalpat/Service/models/pill.dart';
import 'package:medicalpat/Service/notifications/notifications.dart';
...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  final List<MedicineType> medicineTypes = [
    MedicineType("Syrup", Image.asset("assets/images01/syrup.png"), true),
    MedicineType("Pill", Image.asset("assets/images01/pills.png"), false),
    MedicineType("Capsule", Image.asset("assets/images01/capsule.png"), false),
    MedicineType("Cream", Image.asset("assets/images01/cream.png"), false),
    MedicineType("Drops", Image.asset("assets/images01/drops.png"), false),
    MedicineType("Syringe", Image.asset("assets/images01/syringe.png"), false),
  ];
